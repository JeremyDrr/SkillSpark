 ...
 */
final class Version20240513195453 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE course (id INT AUTO_INCREMENT NOT NULL, instructor_id INT NOT NULL, level_id INT NOT NULL, title VARCHAR(255) NOT NULL, introduction VARCHAR(255) NOT NULL, thumbnail VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, price DOUBLE PRECISION NOT NULL, stripe_product_id VARCHAR(255) NOT NULL, stripe_price_id VARCHAR(255) NOT NULL, active TINYINT(1) DEFAULT NULL, INDEX IDX_169E6FB98C4FC193 (instructor_id), INDEX IDX_169E6FB95FB14BA7 (level_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
